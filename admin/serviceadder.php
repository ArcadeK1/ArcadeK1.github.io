...
<body>
    ...
    <div class="addnewspage">
        ...
        <form action="logic/newservice.php" method="post">
        <label for="title">Название услуги:</label><br>
        <input type="text" style="width: 460px;" id="title" name="servicename" required><br><br>
        
        <label for="image">Изображение:</label><br>
        <input type="file" id="image" name="image" accept="image/*" required><br><br>
        
        <input id = "createbtn" type="submit" value="Добавить услугу">
        </div>
